...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Noto+Sans&weight=600&pause=1000&color=1daa61&center=true&vCenter=true&width=435&lines=Soy+un+Desarrollador+Full+Stack.+%F0%9F%98%8D" alt="Typing SVG">
</p>
...
<p align="justify">Soy Miguel Reyes Sanchez, Técnico con experiencia en Ingeniería de Software con Inteligencia Artificial, especialista en desarrollo Back End, Base de datos, Experiencia de Usuario (UX/UI), Frameworks y Librerías, implemento integración entre sistemas distribuidos y Control de Versiones, realizo mantenimiento preventivos y correctivos. Optimizar calidad de software, aplicar buenas prácticas, trabajo en equipo y aprendizaje continuo.

He trabajado con tecnologías como HTML5, CSS, PHP,JavaScript, Node.js, Java, C#, MySQL, SQL server y Git, desarrollando soluciones que integran bases de datos relacionales, manejo de errores. También tengo experiencia en la integración de APIs con aplicaciones móviles desarrolladas en Xamarin.Forms (C#).
